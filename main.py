...
from supabase_api import fetch_feeds_by_category, fetch_category, fetch_all_feeds
...
def get_feed_category_list(category_id: int):
    try:
...
@app.post("/publish/")
def publish_entry(category_id: int):
